...
TOKEN = 'NzQ2NDM4ODA1NzQ1MTcyNTAy.X0AVTw.S996WzDc7nV0JnUvnQPpiVuOKu4'
...
async def on_member_join(member):
    ...
    await client.send_message(discord.Object(id='746634952858402928'), 'Welcome' + member.name + ' :star_struck:')
    print("Sent message to " + member.name)
    print("Sent message about " + member.name + " to【🔑】𝕨𝕖𝕝𝕔𝕠𝕞𝕖 (CHANNEL)")
...
async def on_message(message):
        ...
        if message.content.startswith('!help'):
            ...
            print('!stop')
            await _channel.send('Leaving server. BYE!', tts=True)
            await quiz.stop()
